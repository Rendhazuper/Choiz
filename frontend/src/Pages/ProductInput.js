...
const ProductInput = () => {
    ...
    const handleSizeChange = (sizeValue) => {
        ...
        if (sizes.includes(sizeValue)) {
            ...
            const newStok = { ...stok };
            delete newStok[sizeValue]; // Remove stock entry if size is deselected
            setStok(newStok);
        } else {
            setSizes([...sizes, sizeValue]);
            setStok({ ...stok, [sizeValue]: 0 }); // Initialize stock for new size
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        // Validate input
        if (!namaProduk || !sizes.length || !warna || !kategori || !harga || !gambarProduk || !deskripsi) {
        ...
        formData.append("sizes", JSON.stringify(sizes)); // Send sizes as JSON
        formData.append("warna", warna);
        formData.append("kategori", kategori);
        formData.append("stocks", JSON.stringify(stok)); // Send stocks as JSON
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setMessage(response.data.error || "Terjadi kesalahan saat menambahkan produk.");
                setVariant("danger");
            }
        } catch (error) {
            if (error.response) {
                setMessage(error.response?.data?.error || "Terjadi kesalahan saat menambahkan produk.");
                setVariant("danger");
                            ...
                            <Form onSubmit={handleSubmit}>
                                <Row>
                                    <Form.Group className="mb-3" controlId="namaProduk">
                                        ...
                                        <Form.Control type="text" placeholder="Masukkan nama produk" value={namaProduk} onChange={(e) => setNamaProduk(e.target.value)} />
                                    </Form.Group>
                                </Row>
                                ...
                                <Row>
                                    <Form.Group className="mb-3" controlId="warna">
                                        ...
                                        <Form.Control type="text" placeholder="Masukkan warna produk" value={warna} onChange={(e) => setWarna(e.target.value)} />
                                    </Form.Group>
                                </Row>
                                ...
                                <Row>
                                    <Form.Group className="mb-3" controlId="kategori">
                                        ...
                                        <Form.Control type="text" placeholder="Masukkan kategori produk" value={kategori} onChange={(e) => setKategori(e.target.value)} />
                                    </Form.Group>
                                </Row>
                                ...
                                <Row>
                                    <Form.Group className="mb-3" controlId="harga">
                                        ...
                                        <Form.Control type="number" placeholder="Masukkan harga produk" value={harga} onChange={(e) => setHarga(e.target.value)} />
                                    </Form.Group>
                                </Row>
                                ...
                                <Row>
                                    <Form.Group className="mb-3" controlId="deskripsi">
                                        ...
                                        <Form.Control as="textarea" rows={3} placeholder="Masukkan deskripsi produk" value={deskripsi} onChange={(e) => setDeskripsi(e.target.value)} />
                                    </Form.Group>
                                </Row>

                                <Row>
                                    <Button className="Button" type="submit">Tambah Produk</Button>
                                </Row>
